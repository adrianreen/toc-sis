{{-- resources/views/extension-requests/staff-index.blade.php --}}
<x-app-layout>
    <x-slot name="header">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ $extensionRequests->where('status', 'pending')->count() }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ $extensionRequests->where('status', 'approved')->count() }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ $extensionRequests->where('status', 'rejected')->count() }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ $extensionRequests->total() }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white shadow-sm rounded-lg">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">All Extension Requests</h3>
                    <p class="mt-1 text-sm text-gray-600">
                        Review and manage student extension requests below.
                    </p>
                </div>
                                ...
                                @foreach($extensionRequests as $request)
                                    <tr class="hover:bg-gray-50 {{ $request->isPending() ? 'bg-yellow-50' : '' }}">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3">
                                                    ...
                                                    <div class="text-sm text-gray-500">{{ $request->student_number }}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            @if($request->requiresMedicalCertificate())
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if($request->extension_fee > 0)
                                                <div class="text-sm font-medium text-gray-900">€{{ number_format($request->extension_fee, 2) }}</div>
                                                @if($request->fee_paid)
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex space-x-2">
                                                ...
                                                @if($request->isPending())
                                                    <a href="{{ route('extension-requests.review', $request) }}" 
                ...
                @else
                    ...
                    <div class="text-center py-12">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Students haven't submitted any extension requests yet.</p>
                    </div>
                @endif
            </div>
        </div>
