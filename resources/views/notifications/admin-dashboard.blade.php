{{-- resources/views/notifications/admin-dashboard.blade.php --}}
<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('notifications.announcement') }}" 
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">{{ number_format($stats['recent_notifications']) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">{{ number_format($stats['email_notifications_sent']) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            @foreach($recentNotifications as $notification)
                                <div class="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg">
                                    <div class="flex-shrink-0">
                                        ...
                                        @elseif($notification->type === 'grade_released')
                                            <div class="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
                                                <svg class="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                                </svg>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex items-center mt-2 text-xs text-gray-500">
                                            <span>To: {{ $notification->user->first_name ?? 'Unknown' }} {{ $notification->user->last_name ?? 'User' }}</span>
