        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4" x-data="{ 
                    ...
                    async markAllRead() {
                        if (!confirm(`Mark all ${this.unreadCount} notifications as read?`)) return;
                    ...
                    <span class="text-sm text-gray-500">
                        <span class="font-medium" x-text="unreadCount"></span> unread
                    </span>
                    <button @click="markAllRead()" 
                            :disabled="isMarking"
                            :class="{ 'opacity-50 cursor-not-allowed': isMarking }"
                        ...
                        <span x-text="isMarking ? 'Marking as read...' : `Mark All ${unreadCount} Read`"></span>
                    </button>
                </div>
                @endif
            </div>
